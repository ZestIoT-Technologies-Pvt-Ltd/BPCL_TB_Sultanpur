...
def view_detection(view_coords,view_scores,roi):
	...
	for person in range(0,roi):
		...
		if (((nose_y < left_eye_y) and (nose_y > right_eye_y) and ((nose_x+42 > left_shoulder_x and nose_x+42 > right_shoulder_x) and (left_ear_score >= 0.1 and right_ear_score >= 0.1)))  or ( left_ear_score < 0.1 and right_ear_score >= 0.3 and left_eye_score >= 0.1 and  right_eye_score >= 0.2 and (nose_x+42 > left_shoulder_x and nose_x+42 > right_shoulder_x) and ((right_shoulder_x - right_eye_x) < 31))) :
